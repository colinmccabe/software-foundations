...
Theorem not_both_true_and_false : forall P : Prop,
  ~ (P /\ ~P).
Proof.
  unfold not. intros. destruct H as [HP HPF].
...
Proof.
  ...
  intros; destruct HPQ; destruct HQR; auto.
Qed.
(** [] *)
...
Proof.
  ...
  - induction l.
    + intros. destruct H.
      * inversion H.
      * assumption.
    + intros. simpl. simpl in H. destruct H. destruct H.
      * left. assumption.
...
Proof.
  ...
  - induction l.
    * intros. inversion H0.
    * intros H. simpl in H. simpl. intros. destruct H. destruct H0.
...
Proof.
  ...
  - simpl. rewrite <- IHl'. unfold tr_rev. simpl.
    assert (forall (l1 : list X), rev_append l1 [] ++ [y] = rev_append l1 [y]).
...
Proof.
  ...
  - destruct IHn as [k]. rewrite evenb_S.
    destruct (evenb n).
