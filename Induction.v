...
(** Briefly explain the difference between the tactics [destruct] 
    ...
    substituting the term with the constructor.
    [induction] does the same, but adds an induction hypothesis
    to the context if the constructor is non-nullary.
*)
(** [] *)
...
Proof.
  ...
  - simpl. rewrite <- plus_n_O. rewrite <- plus_n_O.
    rewrite IHb'. rewrite <- plus_n_Sm. reflexivity.
Qed.
(** [] *)
